...
const boardsReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CONSTANTS.IMPORT_BOARD: {
      ...
      const newState = { ...state, [newID]: newBoard };//we use the spread operator to keep the old state and to add the new imported board
      return newState;
    }
    ...
    case CONSTANTS.ADD_LIST: {
     ...
     const newLists = [...board.lists, newListID];//when we know the exact board we will only spread the board.lists structure and we will add the new list there
      board.lists = newLists;
      
      return { ...state, [boardID]: board };//we return the old state plus the edited board
    }
    ...
    case CONSTANTS.DRAG_HAPPENED: {
      ...
      if (type === "list") {
        ...
        return { ...state, [boardID]: board };//we return and update the state of the new list order
      }
      return state;
    }
